...
cluster = SLURMCluster(
    ...
    job_extra_directives=[
        '--propagate',
        f'--output={output_dir}/h2dradec_dask_job_%j.out',  # Redireciona a saída para a pasta output
        f'--error={output_dir}/h2dradec_dask_job_%j.err'    # Redireciona o erro para a pasta output
    ],
)
...
performance_report_path = os.path.join(logs_dir, f'performance_report_histo_2d_ra_dec.html')
